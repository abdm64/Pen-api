const array_req = {
    ...
    searchTable : [ `select  num , c.nom_commune as commune  , w.nom_wilaya as wilaya  , etat  from "App_Pdv" ap  inner join "App_Commune"  c on ap.id_commune = c.id_commune  inner join  "App_Wilaya"  w on c.id_wilaya  = w.id_wilaya `]
}
